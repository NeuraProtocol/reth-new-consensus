...
impl ValidatorKeyPair {
    ...
    pub fn generate() -> Result<Self> {
        ...
        let evm_private_key = EvmSecretKey::from_slice(&key_bytes)
    ...
    pub fn from_seed(seed: &str) -> Result<Self> {
        ...
        let evm_private_key = EvmSecretKey::from_slice(&evm_key_bytes)
...
/// This is the working implementation that has proper committee creation
#[derive(Debug, Clone)]
...
impl ValidatorRegistry {
    ...
    /// This is the key working method that was in the pre-move version
